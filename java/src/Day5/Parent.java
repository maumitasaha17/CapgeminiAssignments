...
public class Parent {
	...
	// if class is declared final in the parent class then it cant be inhereted to
	// child class
	// whenever a class is having abstract method then there isnt any implementation
	// happening.
